...
if (display == "Europe-old") and (number_sensitivities <= 1):
...
if (display == "Germany-only") and (number_sensitivities <= 1):
    ...
    ds = xr.open_dataset("data/DE-only-main_scenarios_streamlit.nc")
...
if (display == "Germany-old") and (number_sensitivities <= 1):
